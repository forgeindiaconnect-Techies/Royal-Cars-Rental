      ...
      <div style={{ marginBottom: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.4rem', background: '#fff', padding: '0.25rem', borderRadius: '10px', border: '1px solid #cbd5e1' }}>
          ...
          <button
            ...
            style={{
              padding: '0.45rem 0.95rem', borderRadius: '8px', fontSize: '0.82rem', fontWeight: 800, cursor: 'pointer', border: 'none',
              background: activeTab === 'admin-profile' ? '#2563eb' : 'transparent',
              color: activeTab === 'admin-profile' ? '#ffffff' : '#64748b',
              transition: 'all 0.2s ease'
            }}
          >
            ...
            <div style={{ borderTop: '1px solid #e2e8f0', paddingTop: '1rem', marginTop: '0.5rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
                <div>
                  ...
                  <input type="password" value={currentPass} onChange={e => setCurrentPass(e.target.value)} style={{ width: '100%', height: '42px', padding: '0 0.75rem', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '0.88rem' }} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="password" value={confirmPass} onChange={e => setConfirmPass(e.target.value)} style={{ width: '100%', height: '42px', padding: '0 0.75rem', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '0.88rem' }} />
                </div>
              </div>
            </div>
